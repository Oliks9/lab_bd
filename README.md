...
число попыток не ограничено. Начальные результаты и попытки не создаются.
...
Для новой установки перенесите папку `sql` целиком: `install.sql` включает новый
`07_seed/03_subjects_and_users.sql`. В SQL Developer установите кодировку UTF-8,
